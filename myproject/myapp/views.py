...
data = pd.read_csv(r"C:\Users\Pooja Sri L\drugpro\myproject\drug_complete_dataset.csv")
...
medicine_dataset_path = r"C:\Users\Pooja Sri L\drugpro\myproject\medicine_dataset.csv"  # Update this path as needed
...
# Paths to images
background_image_first_page_path = r"C:\Users\Pooja Sri L\drugpro\myproject\static\images\image1.jpg"  # Background image 1
background_image_other_pages_path = r"C:\Users\Pooja Sri L\drugpro\myproject\static\images\image2.jpg"  # Background image 2
...
def more_drug_info(request):
    if request.method == 'POST':
        ...
        df = pd.read_csv(r"C:\Users\Pooja Sri L\drugpro\myproject\drug_complete_dataset.csv")
...
# Load the data
data_path = r"C:\Users\Pooja Sri L\drugpro\myproject\drug_complete_dataset.csv"
...
# Load datasets
df_kerala = pd.read_csv(r"C:\Users\Pooja Sri L\drugpro\myproject\land_sort.csv", encoding='latin1')
...
df_up = pd.read_csv(r"C:\Users\Pooja Sri L\drugpro\myproject\earth_sort.csv", encoding='latin1')
...
def hiv(request):
    # Load your dataset
    df = pd.read_csv(r'C:\Users\Pooja Sri L\drugpro\myproject\HIV.csv')
...
# Loading the synthetic dataset
df = pd.read_csv(r"C:\Users\Pooja Sri L\drugpro\myproject\syntatic_dataset.csv")
# Function to highlight keywords related to misuse
def highlight_misuse(review):
    keywords = ["addictive", "dependent", "addicted", "craving", "withdrawal"]
    pattern = re.compile(r'\b(' + '|'.join(keywords) + r')\b', re.IGNORECASE)
